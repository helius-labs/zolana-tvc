...
- [Privacy-wallet profile](privacy-wallet.md): complete operation and risk record.
- [Wallet flows](wallet-flows.md): setup, sync, shield, transfer, and unshield.
- [Security](security.md): guarantees, assumptions, and production blockers.
